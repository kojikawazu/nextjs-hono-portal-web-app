...
| jsdoc.md | `src/**` | JSDoc（TSDoc）規約（公開シンボルに必須） |
| frontend.md | `src/app/**`, `src/components/**`, `src/lib/**` | Next.js フロントエンド設計・コンポーネント規約 |
| api.md | `src/app/api/**` | Hono API 設計・ルート構成（Next.js 一体型） |
