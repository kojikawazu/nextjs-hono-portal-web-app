...
- [3. sessionStorageデータ](#3-sessionstorageデータ)
  - [3.1 お問い合わせフォームデータ](#31-お問い合わせフォームデータ)
- [4. データフロー](#4-データフロー)
  - [4.1 共通データフロー](#41-共通データフロー)
  - [4.2 お問い合わせデータフロー](#42-お問い合わせデータフロー)
- [5. 環境変数（データ関連）](#5-環境変数データ関連)
...
| `GCS_AIUSAGE_DATA_PATH` | AI 活用方法データJSONファイルのパス |
